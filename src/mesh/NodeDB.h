...
#define NODEINFO_BITFIELD_ROUTING_CAPABLE_SHIFT 1
#define NODEINFO_BITFIELD_ROUTING_CAPABLE_MASK (1 << NODEINFO_BITFIELD_ROUTING_CAPABLE_SHIFT)
#define NODEINFO_BITFIELD_LEGACY_SHIFT 2
#define NODEINFO_BITFIELD_LEGACY_MASK (1 << NODEINFO_BITFIELD_LEGACY_SHIFT)
